...
print("client secret is /n" + str(bank_secret))
...
mgmt_req_body = 'grant_type=client_credentials&client_secret='+str(bank_secret)+'&client_id=2b0ce5a8-0146-4b0c-a7ef-eccdb99b555b&resource=https%3A%2F%2Fmanagement.azure.com%2F'
